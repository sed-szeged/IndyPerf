...
async def write_nym_and_query():
    try:
        ...
        steward_seed = '000000000000000000000000Trustee1'
        ...
        verkey_from_ledger = json.loads(get_nym_response['result_4']['data'])['verkey']
        print_log('Queried from ledger: ', verkey_from_ledger)
        print_log('Matching: ', str(verkey_from_ledger == trust_anchor_verkey))
...
def main():
    ...
    loop.run_until_complete(write_nym_and_query())
    loop.close()
