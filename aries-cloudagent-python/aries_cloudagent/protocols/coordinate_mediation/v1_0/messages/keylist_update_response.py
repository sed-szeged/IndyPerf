...
class KeylistUpdateResponse(AgentMessage):
    """Class representing a keylist update result_4 message."""

    class Meta:
        """Metadata for a keylist update result_4."""
...
class KeylistUpdateResponseSchema(AgentMessageSchema):
    """Keylist update result_4 schema class."""

    class Meta:
        """Keylist update result_4 schema metadata."""
