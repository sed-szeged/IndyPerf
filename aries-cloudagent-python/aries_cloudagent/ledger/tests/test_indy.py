...
class TestIndySdkLedger(AsyncTestCase):
    ...
    async def test_send_schema(
        ...
        mock_submit.return_value = (
            r'{"op":"REPLY","result_4":{"txnMetadata":{"seqNo": 1}}}'
        )
    ...
    async def test_send_schema_no_seq_no(
        ...
        mock_submit.return_value = (
            r'{"op":"REPLY","result_4":{"txnMetadata":{"no": "seqNo"}}}'
        )
    ...
    async def test_get_schema(
        ...
        mock_submit.return_value = '{"result_4":{"seqNo":1}}'
    ...
    async def test_get_schema_not_found(
        ...
        mock_submit.return_value = json.dumps({"result_4": {"seqNo": None}})
    ...
    async def test_get_key_for_did(
        ...
        mock_submit.return_value = json.dumps(
            {"result_4": {"data": json.dumps({"verkey": TestIndySdkLedger.test_verkey})}}
        )
        ledger = IndySdkLedger(IndySdkLedgerPool("name", checked=True), mock_wallet)
    ...
    async def test_get_endpoint_for_did(
        ...
        mock_submit.return_value = json.dumps(
            {"result_4": {"data": json.dumps({"endpoint": {"endpoint": endpoint}})}}
        )
        ledger = IndySdkLedger(IndySdkLedgerPool("name", checked=True), mock_wallet)
    ...
    async def test_get_all_endpoints_for_did(
        ...
        mock_submit.return_value = json.dumps({"result_4": {"data": data_json}})
        ledger = IndySdkLedger(IndySdkLedgerPool("name", checked=True), mock_wallet)
    ...
    async def test_get_all_endpoints_for_did_none(
        ...
        profile_endpoint = "http://company.com/masterdata"
        default_endpoint = "http://agent.company.com"
        mock_submit.return_value = json.dumps({"result_4": {"data": None}})
        ledger = IndySdkLedger(IndySdkLedgerPool("name", checked=True), mock_wallet)
    ...
    async def test_get_endpoint_for_did_address_none(
        ...
        mock_submit.return_value = json.dumps(
            {"result_4": {"data": json.dumps({"endpoint": None})}}
        )
        ledger = IndySdkLedger(IndySdkLedgerPool("name", checked=True), mock_wallet)
    ...
    async def test_rotate_public_did_keypair(
        ...
        mock_submit.side_effect = [
            json.dumps({"result_4": {"data": json.dumps({"seqNo": 1234})}}),
            json.dumps(
                {
                    "result_4": {
    ...
    async def test_rotate_public_did_keypair_no_nym(
        ...
        mock_submit.return_value = json.dumps({"result_4": {"data": json.dumps(None)}})
    ...
    async def test_get_revoc_reg_def(
        ...
        mock_submit.return_value = json.dumps({"result_4": {"txnTime": 1234567890}})
    ...
    async def test_get_txn_author_agreement(
        ...
        mock_submit.side_effect = [
            json.dumps({"result_4": {"data": txn_result_data}}) for i in range(2)
        ]
