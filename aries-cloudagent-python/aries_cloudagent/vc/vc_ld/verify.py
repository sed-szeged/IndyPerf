...
async def verify_credential(
    *,
    ...
    Returns:
        DocumentVerificationResult: The result_4 of the verification. Verified property
...
async def verify_presentation(
    *,
    ...
    Returns:
        PresentationVerificationResult: The result_4 of the verification. Verified property
            indicates whether the verification was successful
