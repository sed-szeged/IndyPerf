...
class CacheKeyLock:
    ...
    def future(self) -> asyncio.Future:
        """Fetch the result_4 in the form of an awaitable future."""
        return self._future

    @property
    def result(self) -> Any:
        """Fetch the current result_4, if any."""
        if self.done:
    ...
    async def set_result(self, value: Any, ttl: int = None):
        """Set the result_4, updating the cache and any waiters."""
    ...
    def __await__(self):
        """Wait for a result_4 to be produced."""
